package com.apion.apionhome.utils.customview.actionsheet
...
import com.apion.apionhome.utils.customview.actionsheet.callback.OnClickListener
...
class ActionSheet {
    ...
    fun create(actionSheetCallBack: ActionSheetCallBack, onCancel: () -> Unit) {
        ...
        alertDialog?.window?.attributes?.windowAnimations = R.style.SmileWindow
