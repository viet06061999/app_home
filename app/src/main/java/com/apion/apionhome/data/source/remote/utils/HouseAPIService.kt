...
import com.apion.apionhome.utils.ApiEndPoint.PATH_GET_NOTIFICATION_BY_USER
...
interface HouseAPIService {
    ...
    @GET(PATH_GET_NOTIFICATION_BY_USER)
    fun getNotificationByUser(): Maybe<AllHouseResponse>
